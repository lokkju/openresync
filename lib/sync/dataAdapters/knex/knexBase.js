// This file includes the base functionality for data adapters that are based on knex.
// only knex-interpreted sql is supported.
// raw sql statements should only be used in individual data adapters.
